 ...
 */
function num_to_letras($numero, $moneda = 'Y', $subfijo = 'SOLES')
{
    $xarray = array(
        0 => 'Cero'
...
function agregar_ceros($num,$sufijo){
    $cadena_retorno='';
    if ($sufijo==1) {
        $sufijo='F';
    }else{
    ...
    if ($num<10) {
        $cadena_retorno=$sufijo."00".$num;
    }else if($num>=10){
        $cadena_retorno=$sufijo."0".$num;
    }
...
*
*/
function letra_modena($nombre_moneda){
    switch ($nombre_moneda) {
        case 'USD':
            return "DOLARES";
            break;
        case 'PEN':
