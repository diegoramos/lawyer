...
<body onload="window.print();">
    <div class="page">
    	...
    	<p class="text-center">RECIBO N°: <?php echo $info->consulta_id; ?></p>
        <table>
            <tr>
                <td>Fecha/Hora:</td>
        ...
        <table>
            <tr>
                ...
                <td><?php echo $info->tipo_consulta; ?></td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                ...
                <td class="right">S/.</td>
                <td class="right"><?php echo $info->a_cuenta; ?></td>
            </tr>
            <tr>
        ...
        EFECTIVO S/ : <?php  echo ($info->a_cuenta == 0.00) ? $info->total : $info->a_cuenta; ?></p>
        <p class="text-center"><img src="<?php echo base_url() ?>upload/<?php echo $info->consulta_id.'.png';?>" alt="QR-code" class="left"/></p>
