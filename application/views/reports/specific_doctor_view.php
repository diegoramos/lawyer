    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          $param_get='';
          $param_get .=(isset($_GET['report_type']))?"&report_type=".$_GET['report_type']:'';
          $param_get .=(isset($_GET['with_time']))?"&with_time=".$_GET['with_time']:'';
          $param_get .=(isset($_GET['end_date_end_of_day']))?"&end_date_end_of_day=".$_GET['end_date_end_of_day']:'';
          $param_get .=(isset($_GET['report_date_range_simple']))?"&report_date_range_simple=".$_GET['report_date_range_simple']:'';
          $param_get .=(isset($_GET['start_date_formatted']))?"&start_date_formatted=".$_GET['start_date_formatted']:'';
          $param_get .=(isset($_GET['start_date']))?"&start_date=".$_GET['start_date']:'';
          $param_get .=(isset($_GET['end_date_formatted']))?"&end_date_formatted=".$_GET['end_date_formatted']:'';
          $param_get .=(isset($_GET['end_date']))?"&end_date=".$_GET['end_date']:'';
          $param_get .=(isset($_GET['specific_doctor']))?"&specific_doctor=".$_GET['specific_doctor']:'';

          if ($pageno == 1) {
             echo '<a class="" style="background-color: #ABEBC6;border-radius: 2px;border: 1px solid #000 ;text-decoration: none;color: #000;">FIRST PREV</a>';
          } else {
             echo ' <a href="?pageno=1'.$param_get.'" style="background-color: #2ECC71;border-radius: 10px;border: 1px solid #000 ;text-decoration: none;color: #000;">FIRST</a> ';
             $prevpage = $pageno-1;
             echo ' <a href="?pageno='.$prevpage.$param_get.'" style="background-color: #2ECC71;border-radius: 10px;border: 1px solid #000 ;text-decoration: none;color: #000;">PREV</a> ';
          }
             echo " ( Page $pageno of $lastpage ) ";

         if ($pageno == $lastpage) {
               echo '<a class="" style="background-color: #ABEBC6;border-radius: 2px;border: 1px solid #000 ;text-decoration: none;color: #000;">NEXT LAST</a>';
            } else {
               $nextpage = $pageno+1;
               echo '<a href="?pageno='.$nextpage.$param_get.'" style="background-color: #2ECC71;border-radius: 2px;border: 1px solid #000 ;text-decoration: none;color: #000;">NEXT</a>';
               echo ' <a href="?pageno='.$lastpage.$param_get.'" style="background-color: #2ECC71;border-radius: 2px;border: 1px solid #000 ;text-decoration: none;color: #000;">LAST</a> ';
            }
